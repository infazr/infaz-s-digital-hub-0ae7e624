    ...
    <section id="contact" className="py-16 sm:py-24 bg-secondary/30">
      <div className="container px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4">Let's Work Together</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              {contactInfo.map((item) => (
                <div key={item.label} className="flex items-center gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-card border border-border flex items-center justify-center text-primary">
              ...
              <div className="flex gap-2 sm:gap-3">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="p-2.5 sm:p-3 rounded-lg bg-card border border-border hover:border-primary/50 hover:text-primary transition-all"
            ...
            <div className="mt-6 sm:mt-8 p-4 sm:p-6 rounded-xl bg-card border border-border">
              <h4 className="font-semibold mb-2 text-sm sm:text-base">Services I Offer</h4>
          ...
          {/* Contact Form */}
          <div className="p-5 sm:p-8 rounded-xl bg-card border border-border">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-[120px] sm:min-h-[140px] resize-none text-sm"
                  required
                />
              </div>
